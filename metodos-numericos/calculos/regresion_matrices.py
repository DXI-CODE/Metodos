...
def regresion_por_matrices(tipo, x, y):
    ...
    # Matrices y coeficientes dependiendo del tipo de regresión
    if tipo == 'lineal':
        ...
        A = np.array([[n, sum_x, sum_x2, sum_x3], [sum_x, sum_x2, sum_x3, sum_x4], [sum_x2, sum_x3, sum_x4, np.sum(x**5)], [sum_x3, sum_x4, np.sum(x**5), np.sum(x**6)]])
